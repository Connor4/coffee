...
const val FORMULA_PROPERTY_MANUAL_FOAM_TIME = "manualFoamTime"
const val FORMULA_PROPERTY_AUTO_FOAM_TEMP = "autoFoamTemperature"
...
const val MILK_SOURCE_NAME_LEFT = 1
const val MILK_SOURCE_NAME_RIGHT = 2
const val MILK_SOURCE_TEMP = 3
const val MILK_SOURCE_MILK_CALIBRATION = 4
const val MILK_SOURCE_FOAM_CALIBRATION = 5
const val MILK_REVERSE_FLUSHING_LEFT = 1
const val MILK_REVERSE_FLUSHING_RIGHT = 2
...
// 豆仓磨刀模块
const val REAR_HOPPER_NAME = "rear_hopper_name"
const val FRONT_HOPPER_NAME = "front_hopper_name"
const val LEVELLING = "levelling"
const val PQC = "pqc"
const val GRINDING_CAPACITY_FRONT = "grinding_capacity_front"
const val GRINDING_CAPACITY_REAR = "grinding_capacity_rear"
const val ETC_FRONT = "etc_front"
const val ETC_REAR = "etc_rear"
const val GRINDER_LIMIT_CAPACITY_REAR = "grinder_limit_capacity_rear"
const val GRINDER_LIMIT_CAPACITY_FRONT = "grinder_limit_capacity_front"
const val ETC_FRONT_REFERENCE = "etc_front_reference"
const val ETC_REAR_REFERENCE = "etc_rear_reference"