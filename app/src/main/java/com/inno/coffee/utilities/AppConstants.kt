...
const val MACHINE_TEST_WATER_PUMP_ID = 301
const val MACHINE_TEST_WATER_INLET_VALVE = 302
const val MACHINE_TEST_BREW_VALVE_LEFT = 303
const val MACHINE_TEST_BYPASS_VALVE_LEFT = 304
const val MACHINE_TEST_AMERICANO_LEFT = 305
const val MACHINE_TEST_BREW_VALVE_RIGHT = 306
const val MACHINE_TEST_BYPASS_VALVE_RIGHT = 307
const val MACHINE_TEST_AMERICANO_RIGHT = 308
const val MACHINE_TEST_BALL_DISPENSER_FORWARD = 309
const val MACHINE_TEST_BALL_DISPENSER_BACKWARD = 310
const val MACHINE_TEST_BOILER_LEFT = 311
const val MACHINE_TEST_BOILER_RIGHT = 312
const val MACHINE_TEST_GRINDER_LEFT = 313
const val MACHINE_TEST_GRINDER_RIGHT = 314
const val MACHINE_TEST_FAN_FRONT = 315
const val MACHINE_TEST_FAN_LEFT = 316
const val MACHINE_TEST_FAN_RIGHT = 317
